...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_NAME = "coupons.db"; //LOOK INTO THIS
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME + " (ID INTEGER PRIMARY KEY AUTOINCREMENT, " +
                " STORE_NAME TEXT, PRODUCT_NAME TEXT, EXPIRATION_DATE TEXT, COUPON_NUMBER TEXT, STORE_FLAG BOOLEAN, STOREN TEXT)";
    ...
    public boolean addData(String storeName, String productName, String expDate, String cNum) {
