                ...
                public boolean onItemLongClick(final AdapterView<?> adapterView, View view, final int i, long l) {
                    ...
                    adb.setNegativeButton("Yes", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            // Gets info from the coupon ArrayList
        ...
        if(coupons != null){
            couponListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    setStoreName(coupons.get(i).getStoreName());
                    setCouponNumber(coupons.get(i).getCouponNumber());
                    byte array[] = database.getImage(coupons.get(i).getStoreName(), coupons.get(i).getCouponNumber());
