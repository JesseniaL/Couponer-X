...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public boolean addData(String storeName, String expDate, String cNum, byte[] image) throws SQLiteException{
    ...
    byte[] getImage(String storeName, String couponNumber){
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor data;
        data = db.rawQuery("SELECT * FROM " + TABLE_NAME + " WHERE " + STORENAME + " = '"+storeName+"'" + " AND "
                + COUP + " = '"+couponNumber+"'", null);
        ...
        return data.getBlob(data.getColumnIndex(IMAGE));
    }
}